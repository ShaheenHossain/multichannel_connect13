...
class ProductProduct(models.Model):
    ...
    def _get_price_extra(self):
        for product in self:
            ...
            for value_id in product.attribute_value_ids:
                for price in value_id.price_ids:
                    if price.product_tmpl_id.id == product.product_tmpl_id.id:
    ...
    def get_product_attribute_value_id(self, attribute_id, product_attribute_id, template_id):
        ...
        attribute_value_mapping = self.env[
            'channel.attribute.value.mappings'].search([('channel_id', '=', context.get('channel_id')),
