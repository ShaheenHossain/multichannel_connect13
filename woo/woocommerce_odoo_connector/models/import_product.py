        ...
        for variant_id in variation_ids:
            ...
            if variant['attributes']:
                ...
                for attributes in variant['attributes']:
                    ...
                    if self.env['channel.attribute.value.mappings'].search([('store_attribute_value_name', '=', attributes['option']), ('channel_id.id', '=', self.id),('attribute_value_name.attribute_id.id', '=', attrib_name_id.attribute_name.id)]):
                        attrib_value_id = self.env['chanheadline nel.attribute.value.mappings'].search([('store_attribute_value_name','=',attributes['option']),('channel_id.id','=',self.id),('attribute_value_name.attribute_id.id','=',attrib_name_id.attribute_name.id)])[0]
                        attrib_value_ids = attrib_value_id.store_attribute_value_id
                    else:
                        attrib_value_ids = ''
            ...
            if 'message' in attribute_data:
                ...
                if attribute_data:
                    ...
                    for attribute in attribute_data:
                        attribute_map = self.env['channel.attribute.mappings'].search([('store_attribute_id','=', attribute['id']),
